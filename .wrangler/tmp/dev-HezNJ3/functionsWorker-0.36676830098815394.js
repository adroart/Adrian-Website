...
// .wrangler/tmp/pages-W0yNfn/functionsWorker-0.36676830098815394.mjs
...
var init_login = __esm({
  "api/admin/login.js"() {
    init_functionsRoutes_0_3594718512998618();
...
async function onRequest(context) {
  ...
  html = html.replace(/<title>[^<]*<\/title>/, `<title>${title}</title>`).replace(/(<meta\s+name="description"\s+content=")[^"]*"/, `$1${description}"`).replace(/(<meta\s+property="og:title"\s+content=")[^"]*"/, `$1${title}"`).replace(/(<meta\s+property="og:description"\s+content=")[^"]*"/, `$1${description}"`).replace(/(<meta\s+property="og:image"\s+content=")[^"]*"/, `$1${image3}"`).replace(/(<meta\s+name="twitter:title"\s+content=")[^"]*"/, `$1${title}"`).replace(/(<meta\s+name="twitter:description"\s+content=")[^"]*"/, `$1${description}"`).replace(/(<meta\s+name="twitter:image"\s+content=")[^"]*"/, `$1${image3}"`).replace(/(<meta\s+property="og:image:width"\s+content=")[^"]*"/, `$1300"`).replace(/(<meta\s+property="og:image:height"\s+content=")[^"]*"/, `$1300"`).replace(/(<meta\s+name="twitter:card"\s+content=")[^"]*"/, `$1summary"`);
...
var init_number = __esm({
  "oracle/universal-language/[number].js"() {
    ...
    OG_CROP = "f_auto,q_auto,w_300,h_300,c_fill,g_center";
    CARD_NAMES = {
      1: "Earth's Breath",
      2: "Beyond the Shell",
...
var init_dist = __esm({
  "../node_modules/superstruct/dist/index.mjs"() {
    ...
    __name2(print, "print");
    __name2(shiftIterator, "shiftIterator");
    __name2(toFailure, "toFailure");
    __name2(toFailures, "toFailures");
    __name2(run, "run");
    Struct = class {
      static {
        __name(this, "Struct");
      ...
      constructor(props) {
        const { type: type2, schema, validator: validator2, refiner, coercer = /* @__PURE__ */ __name2((value) => value, "coercer"), entries = /* @__PURE__ */ __name2(function* () {
        }, "entries") } = props;
        this.type = type2;
        this.schema = schema;
...
function makeGenericAPIRouteHandler(_config, options) {
  ...
  const getParams = /* @__PURE__ */ __name2((req) => {
    let url2;
    try {
  ...
  if (_config2.config.storage.kind === "cloud") {
    return /* @__PURE__ */ __name2(/* @__PURE__ */ __name(async function keystaticAPIRoute() {
      return {
        status: 404,
        body: "Not Found"
      };
    }, "keystaticAPIRoute"), "keystaticAPIRoute");
  }
...
If you've created your GitHub app locally, make sure to copy the environment variables from your local env file to your deployed environment`);
    ...
    return /* @__PURE__ */ __name2(/* @__PURE__ */ __name(async function keystaticAPIRoute(req) {
      const params = getParams(req);
...
var cookie;
var localModeApiHandler;
var handleGitHubAppCreation;
var webcrypto;
var encoder;
var decoder;
var SALT_LENGTH;
var IV_LENGTH;
var keystaticRouteRegex;
var tokenDataResultType;
var init_keystatic_core_api_generic_worker = __esm({
  "../node_modules/@keystatic/core/dist/keystatic-core-api-generic.worker.js"() {
    ...
    SALT_LENGTH = 16;
    IV_LENGTH = 12;
    __name2(encryptValue, "encryptValue");
    __name2(decryptValue, "decryptValue");
    keystaticRouteRegex = /^branch\/[^]+(\/collection\/[^/]+(|\/(create|item\/[^/]+))|\/singleton\/[^/]+)?$/;
    __name2(tryOrUndefined, "tryOrUndefined");
    __name2(makeGenericAPIRouteHandler, "makeGenericAPIRouteHandler");
    ...
    __name2(githubOauthCallback, "githubOauthCallback");
    __name2(getTokenCookies, "getTokenCookies");
    __name2(getRefreshToken, "getRefreshToken");
    __name2(githubRefreshToken, "githubRefreshToken");
    __name2(refreshGitHubAuth, "refreshGitHubAuth");
    __name2(githubRepoNotFound, "githubRepoNotFound");
    __name2(githubLogin, "githubLogin");
    __name2(createdGithubApp, "createdGithubApp");
    __name2(immediatelyExpiringCookie, "immediatelyExpiringCookie");
  }
});
  ...
  "../node_modules/react/cjs/react.development.js"(exports, module) {
    ...
    if (true) {
      (function() {
        ...
        var ReactElement = /* @__PURE__ */ __name2(function(type2, key, ref, self, source, owner, props) {
          var element = {
        ...
        function act(callback) {
          {
            ...
            if (result !== null && typeof result === "object" && typeof result.then === "function") {
              ...
              var thenable = {
                then: /* @__PURE__ */ __name2(function(resolve3, reject) {
                  wasAwaited = true;
...
function dynamic(node2, React, { components = {} } = {}) {
  ...
  __name2(deepRender2, "deepRender2");
...
var __toModule;
var require_tag;
var require_entities;
var require_entities2;
var require_regex;
var require_encode;
var require_decode;
var require_format;
...
var require_uc;
var require_utils;
var require_parse_link_label;
var require_parse_link_destination;
var require_parse_link_title;
var require_helpers;
var require_renderer;
var require_ruler;
var require_normalize;
var require_block;
var require_inline;
var require_linkify;
var require_replacements;
var require_smartquotes;
var require_token;
var require_state_core;
var require_parser_core;
var require_table;
var require_code;
var require_fence;
var require_blockquote;
var require_hr;
var require_list;
var require_reference;
var require_html_blocks;
var require_html_re;
var require_html_block;
var require_heading;
var require_lheading;
var require_paragraph;
var require_state_block;
var require_parser_block;
var require_text;
var require_newline;
var require_escape;
var require_backticks;
var require_strikethrough;
var require_emphasis;
var require_link;
var require_image;
var require_autolink;
var require_html_inline;
var require_entity;
var require_balance_pairs;
var require_text_collapse;
var require_state_inline;
var require_parser_inline;
var require_re;
var require_linkify_it;
var require_punycode;
var require_default;
var require_zero;
var require_commonmark;
var require_lib;
var require_markdown_it;
var base_exports;
var Tag;
var Class;
var Id;
...
var init_dist2 = __esm({
  "../node_modules/@markdoc/markdoc/dist/index.mjs"() {
    ...
    __markAsModule = /* @__PURE__ */ __name2((target) => __defProp22(target, "__esModule", { value: true }), "__markAsModule");
    ...
    __reExport = /* @__PURE__ */ __name2((target, module, desc) => {
      if (module && typeof module === "object" || typeof module === "function") {
        for (let key of __getOwnPropNames2(module))
          if (!__hasOwnProp2.call(target, key) && key !== "default")
            __defProp22(target, key, { get: /* @__PURE__ */ __name2(() => module[key], "get"), enumerable: !(desc = __getOwnPropDesc2(module, key)) || desc.enumerable });
      }
      return target;
    }, "__reExport");
    __toModule = /* @__PURE__ */ __name2((module) => {
      return __reExport(__markAsModule(__defProp22(module != null ? __create2(__getProtoOf2(module)) : {}, "default", module && module.__esModule && "default" in module ? { get: /* @__PURE__ */ __name2(() => module.default, "get"), enumerable: true } : { value: module, enumerable: true })), module);
    }, "__toModule");
      ...
      "src/grammar/tag.js"(exports, module) {
        ...
        peg$SyntaxError.buildMessage = function(expected, found, location) {
          var DESCRIBE_EXPECTATION_FNS = {
            ...
            not: /* @__PURE__ */ __name2(function(expectation) {
        ...
        function peg$parse(input, options) {
          ...
          var peg$f0 = /* @__PURE__ */ __name2(function(variable) {
            return { type: "variable", meta: { variable } };
          }, "peg$f0");
          var peg$f1 = /* @__PURE__ */ __name2(function(attributes) {
            return { type: "annotation", meta: { attributes } };
          }, "peg$f1");
          var peg$f2 = /* @__PURE__ */ __name2(function(tag, value) {
            return value;
          }, "peg$f2");
          var peg$f3 = /* @__PURE__ */ __name2(function(tag, primary, attributes, close) {
            if (primary) {
          ...
          var peg$f4 = /* @__PURE__ */ __name2(function(tag) {
            return { type: "tag_close", nesting: -1, meta: { tag } };
          }, "peg$f4");
          var peg$f5 = /* @__PURE__ */ __name2(function(head, tail) {
            return !head ? [] : [head, ...tail];
          }, "peg$f5");
          var peg$f6 = /* @__PURE__ */ __name2(function(item2) {
            return item2;
          }, "peg$f6");
          var peg$f7 = /* @__PURE__ */ __name2(function(ids) {
            return ids;
          }, "peg$f7");
          var peg$f8 = /* @__PURE__ */ __name2(function(classes) {
            return classes;
          }, "peg$f8");
          var peg$f9 = /* @__PURE__ */ __name2(function(attribute) {
            return attribute;
          }, "peg$f9");
          var peg$f10 = /* @__PURE__ */ __name2(function(name) {
            return { type: "class", name, value: true };
          }, "peg$f10");
          var peg$f11 = /* @__PURE__ */ __name2(function(value) {
            return { type: "attribute", name: "id", value };
          }, "peg$f11");
          var peg$f12 = /* @__PURE__ */ __name2(function(name, value) {
            return { type: "attribute", name, value };
          }, "peg$f12");
          var peg$f13 = /* @__PURE__ */ __name2(function(name, head, tail) {
            return head ? [head, ...tail] : [];
          }, "peg$f13");
          var peg$f14 = /* @__PURE__ */ __name2(function(name, params) {
            let parameters = {};
            for (let [index2, { name: name2, value }] of params.entries())
              parameters[name2 || index2] = value;
            return new Function3(name, parameters);
          }, "peg$f14");
          var peg$f15 = /* @__PURE__ */ __name2(function(name) {
            return name;
          }, "peg$f15");
          var peg$f16 = /* @__PURE__ */ __name2(function(name, value) {
            return { name, value };
          }, "peg$f16");
          var peg$f17 = /* @__PURE__ */ __name2(function(value) {
            return value;
          }, "peg$f17");
          var peg$f18 = /* @__PURE__ */ __name2(function(prefix, head, tail) {
            if (prefix === "@")
              return [head, ...tail];
            return new Variable2([head, ...tail]);
          }, "peg$f18");
          var peg$f19 = /* @__PURE__ */ __name2(function() {
            return null;
          }, "peg$f19");
          var peg$f20 = /* @__PURE__ */ __name2(function() {
            return true;
          }, "peg$f20");
          var peg$f21 = /* @__PURE__ */ __name2(function() {
            return false;
          }, "peg$f21");
          var peg$f22 = /* @__PURE__ */ __name2(function(head, tail) {
            return [head, ...tail];
          }, "peg$f22");
          var peg$f23 = /* @__PURE__ */ __name2(function(value) {
            return value || [];
          }, "peg$f23");
          var peg$f24 = /* @__PURE__ */ __name2(function(head, tail) {
            return Object.assign(head, ...tail);
          }, "peg$f24");
          var peg$f25 = /* @__PURE__ */ __name2(function(value) {
            return value || {};
          }, "peg$f25");
          var peg$f26 = /* @__PURE__ */ __name2(function(key, value) {
            return key === "$$mdtype" ? {} : { [key]: value };
          }, "peg$f26");
          var peg$f27 = /* @__PURE__ */ __name2(function() {
            return parseFloat(text22());
          }, "peg$f27");
          var peg$f28 = /* @__PURE__ */ __name2(function(value) {
            return value.join("");
          }, "peg$f28");
          var peg$f29 = /* @__PURE__ */ __name2(function() {
            return "\n";
          }, "peg$f29");
          var peg$f30 = /* @__PURE__ */ __name2(function() {
            return "\r";
          }, "peg$f30");
          var peg$f31 = /* @__PURE__ */ __name2(function() {
            return "	";
          }, "peg$f31");
          var peg$f32 = /* @__PURE__ */ __name2(function(sequence) {
            return sequence;
          }, "peg$f32");
          var peg$currPos = 0;
          var peg$savedPos = 0;
          ...
          __name2(peg$buildError, "peg$buildError");
          function peg$parseTop() {
            var s0;
            var rule$expects = /* @__PURE__ */ __name2(function(expected2) {
          ...
          __name2(peg$parseTop, "peg$parseTop");
          ...
          __name2(peg$parseTopLevelValue, "peg$parseTopLevelValue");
          ...
          __name2(peg$parseAnnotation, "peg$parseAnnotation");
          ...
          __name2(peg$parseTagOpen, "peg$parseTagOpen");
          ...
          __name2(peg$parseTagClose, "peg$parseTagClose");
          ...
          __name2(peg$parseTagAttributes, "peg$parseTagAttributes");
          ...
          __name2(peg$parseTagAttributesTail, "peg$parseTagAttributesTail");
          ...
          __name2(peg$parseTagAttributesItem, "peg$parseTagAttributesItem");
          ...
          __name2(peg$parseTagShortcutClass, "peg$parseTagShortcutClass");
          ...
          __name2(peg$parseTagShortcutId, "peg$parseTagShortcutId");
          ...
          __name2(peg$parseTagAttribute, "peg$parseTagAttribute");
          ...
          __name2(peg$parseFunction, "peg$parseFunction");
          ...
          __name2(peg$parseFunctionParameter, "peg$parseFunctionParameter");
          ...
          __name2(peg$parseFunctionParameterTail, "peg$parseFunctionParameterTail");
          ...
          __name2(peg$parseTrailingComma, "peg$parseTrailingComma");
          ...
          __name2(peg$parseVariable, "peg$parseVariable");
          ...
          __name2(peg$parseVariableTail, "peg$parseVariableTail");
          ...
          __name2(peg$parseValue, "peg$parseValue");
          ...
          __name2(peg$parseValueNull, "peg$parseValueNull");
          ...
          __name2(peg$parseValueBoolean, "peg$parseValueBoolean");
          ...
          __name2(peg$parseValueArray, "peg$parseValueArray");
          ...
          __name2(peg$parseValueArrayTail, "peg$parseValueArrayTail");
          ...
          __name2(peg$parseValueHash, "peg$parseValueHash");
          ...
          __name2(peg$parseValueHashTail, "peg$parseValueHashTail");
          ...
          __name2(peg$parseValueHashItem, "peg$parseValueHashItem");
          ...
          __name2(peg$parseValueNumber, "peg$parseValueNumber");
          ...
          __name2(peg$parseValueString, "peg$parseValueString");
          ...
          __name2(peg$parseValueStringChars, "peg$parseValueStringChars");
          ...
          __name2(peg$parseValueStringEscapes, "peg$parseValueStringEscapes");
          ...
          __name2(peg$parseIdentifier, "peg$parseIdentifier");
          function peg$parse_() {
            var s0;
            var rule$expects = /* @__PURE__ */ __name2(function(expected2) {
              if (peg$silentFails === 0)
    ...
    require_encode = __commonJS2({
      "node_modules/mdurl/encode.js"(exports, module) {
        ...
        __name2(getEncodeCache, "getEncodeCache");
    ...
    require_decode = __commonJS2({
      "node_modules/mdurl/decode.js"(exports, module) {
        ...
        __name2(getDecodeCache, "getDecodeCache");
    ...
    require_format = __commonJS2({
      "node_modules/mdurl/format.js"(exports, module) {
        "use strict";
        module.exports = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function format2(url2) {
          var result = "";
    ...
    require_utils = __commonJS2({
      "node_modules/markdown-it/lib/common/utils.js"(exports) {
        ...
        __name2(arrayReplaceAt, "arrayReplaceAt");
        ...
        __name2(isValidEntityCode, "isValidEntityCode");
        ...
        __name2(replaceEntityPattern, "replaceEntityPattern");
        ...
        __name2(unescapeAll, "unescapeAll");
        ...
        __name2(replaceUnsafeChar, "replaceUnsafeChar");
        ...
        __name(escapeHtml22, "escapeHtml22");
        __name2(escapeHtml22, "escapeHtml2");
        ...
        __name2(isPunctChar, "isPunctChar");
        ...
        __name2(isMdAsciiPunct, "isMdAsciiPunct");
        ...
        __name2(normalizeReference, "normalizeReference");
        exports.lib = {};
    ...
    require_parse_link_label = __commonJS2({
      "node_modules/markdown-it/lib/helpers/parse_link_label.js"(exports, module) {
        "use strict";
        module.exports = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function parseLinkLabel(state, start, disableNested) {
    ...
    require_parse_link_destination = __commonJS2({
      "node_modules/markdown-it/lib/helpers/parse_link_destination.js"(exports, module) {
        ...
        module.exports = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function parseLinkDestination(str, pos, max2) {
    ...
    require_parse_link_title = __commonJS2({
      "node_modules/markdown-it/lib/helpers/parse_link_title.js"(exports, module) {
        "use strict";
        var unescapeAll = require_utils().unescapeAll;
        module.exports = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function parseLinkTitle(str, pos, max2) {
    ...
    require_renderer = __commonJS2({
      "node_modules/markdown-it/lib/renderer.js"(exports, module) {
        ...
        __name2(Renderer, "Renderer");
        Renderer.prototype.renderAttrs = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function renderAttrs(token) {
          var i, l, result;
          if (!token.attrs) {
            return "";
          }
        ...
        Renderer.prototype.renderToken = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function renderToken(tokens, idx, options) {
    ...
    require_normalize = __commonJS2({
      "node_modules/markdown-it/lib/rules_core/normalize.js"(exports, module) {
        ...
        var NEWLINES_RE = /\r\n?|\n/g;
        var NULL_RE = /\0/g;
        module.exports = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function normalize(state) {
          var str;
    ...
    require_block = __commonJS2({
      "node_modules/markdown-it/lib/rules_core/block.js"(exports, module) {
        "use strict";
        module.exports = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function block4(state) {
          var token;
          if (state.inlineMode) {
    ...
    require_inline = __commonJS2({
      "node_modules/markdown-it/lib/rules_core/inline.js"(exports, module) {
        "use strict";
        module.exports = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function inline4(state) {
    ...
    require_linkify = __commonJS2({
      "node_modules/markdown-it/lib/rules_core/linkify.js"(exports, module) {
        ...
        __name2(isLinkOpen, "isLinkOpen");
        function isLinkClose(str) {
          return /^<\/a\s*>/i.test(str);
        }
        __name(isLinkClose, "isLinkClose");
        __name2(isLinkClose, "isLinkClose");
        module.exports = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function linkify(state) {
    ...
    require_replacements = __commonJS2({
      "node_modules/markdown-it/lib/rules_core/replacements.js"(exports, module) {
        ...
        __name2(replace_scoped, "replace_scoped");
        ...
        __name2(replace_rare, "replace_rare");
        module.exports = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function replace(state) {
          var blkIdx;
    ...
    require_smartquotes = __commonJS2({
      "node_modules/markdown-it/lib/rules_core/smartquotes.js"(exports, module) {
        ...
        __name2(process_inlines, "process_inlines");
        module.exports = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function smartquotes(state) {
          var blkIdx;
          if (!state.md.options.typographer) {
            return;
          }
    ...
    require_token = __commonJS2({
      "node_modules/markdown-it/lib/token.js"(exports, module) {
        ...
        __name(Token, "Token");
        __name2(Token, "Token");
        Token.prototype.attrIndex = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function attrIndex(name) {
          var attrs, i, len;
          if (!this.attrs) {
            return -1;
          }
        ...
        Token.prototype.attrPush = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function attrPush(attrData) {
          if (this.attrs) {
        ...
        Token.prototype.attrSet = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function attrSet(name, value) {
        ...
        Token.prototype.attrGet = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function attrGet(name) {
        ...
        Token.prototype.attrJoin = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function attrJoin(name, value) {
    ...
    require_table = __commonJS2({
      "node_modules/markdown-it/lib/rules_block/table.js"(exports, module) {
        ...
        __name2(escapedSplit, "escapedSplit");
        module.exports = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function table3(state, startLine, endLine, silent) {
    ...
    require_code = __commonJS2({
      "node_modules/markdown-it/lib/rules_block/code.js"(exports, module) {
        "use strict";
        module.exports = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function code2(state, startLine, endLine) {
    ...
    require_fence = __commonJS2({
      "node_modules/markdown-it/lib/rules_block/fence.js"(exports, module) {
        "use strict";
        module.exports = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function fence3(state, startLine, endLine, silent) {
    ...
    require_blockquote = __commonJS2({
      "node_modules/markdown-it/lib/rules_block/blockquote.js"(exports, module) {
        "use strict";
        var isSpace = require_utils().isSpace;
        module.exports = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function blockquote2(state, startLine, endLine, silent) {
    ...
    require_hr = __commonJS2({
      "node_modules/markdown-it/lib/rules_block/hr.js"(exports, module) {
        "use strict";
        var isSpace = require_utils().isSpace;
        module.exports = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function hr2(state, startLine, endLine, silent) {
    ...
    require_list = __commonJS2({
      "node_modules/markdown-it/lib/rules_block/list.js"(exports, module) {
        ...
        __name2(skipBulletListMarker, "skipBulletListMarker");
        ...
        __name2(skipOrderedListMarker, "skipOrderedListMarker");
        ...
        __name2(markTightParagraphs, "markTightParagraphs");
        module.exports = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function list2(state, startLine, endLine, silent) {
    ...
    require_reference = __commonJS2({
      "node_modules/markdown-it/lib/rules_block/reference.js"(exports, module) {
        ...
        var isSpace = require_utils().isSpace;
        module.exports = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function reference(state, startLine, _endLine, silent) {
    ...
    require_html_block = __commonJS2({
      "node_modules/markdown-it/lib/rules_block/html_block.js"(exports, module) {
        ...
        module.exports = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function html_block(state, startLine, endLine, silent) {
    ...
    require_heading = __commonJS2({
      "node_modules/markdown-it/lib/rules_block/heading.js"(exports, module) {
        "use strict";
        var isSpace = require_utils().isSpace;
        module.exports = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function heading2(state, startLine, endLine, silent) {
    ...
    require_lheading = __commonJS2({
      "node_modules/markdown-it/lib/rules_block/lheading.js"(exports, module) {
        "use strict";
        module.exports = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function lheading(state, startLine, endLine) {
    ...
    require_paragraph = __commonJS2({
      "node_modules/markdown-it/lib/rules_block/paragraph.js"(exports, module) {
        "use strict";
        module.exports = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function paragraph2(state, startLine) {
    ...
    require_state_block = __commonJS2({
      "node_modules/markdown-it/lib/rules_block/state_block.js"(exports, module) {
        ...
        StateBlock.prototype.isEmpty = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function isEmpty(line) {
          return this.bMarks[line] + this.tShift[line] >= this.eMarks[line];
        }, "isEmpty"), "isEmpty");
        StateBlock.prototype.skipEmptyLines = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function skipEmptyLines(from) {
        ...
        StateBlock.prototype.skipSpaces = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function skipSpaces(pos) {
          var ch;
        ...
        StateBlock.prototype.skipSpacesBack = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function skipSpacesBack(pos, min) {
          if (pos <= min) {
            return pos;
          }
          while (pos > min) {
          ...
          return pos;
        }, "skipSpacesBack"), "skipSpacesBack");
        StateBlock.prototype.skipChars = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function skipChars(pos, code2) {
          for (var max2 = this.src.length; pos < max2; pos++) {
        ...
        StateBlock.prototype.skipCharsBack = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function skipCharsBack(pos, code2, min) {
          if (pos <= min) {
            return pos;
          }
          while (pos > min) {
          ...
          return pos;
        }, "skipCharsBack"), "skipCharsBack");
        StateBlock.prototype.getLines = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function getLines(begin, end, indent, keepLastLF) {
    ...
    require_parser_block = __commonJS2({
      "node_modules/markdown-it/lib/parser_block.js"(exports, module) {
        ...
        __name2(ParserBlock, "ParserBlock");
    ...
    require_text = __commonJS2({
      "node_modules/markdown-it/lib/rules_inline/text.js"(exports, module) {
        ...
        __name2(isTerminatorChar, "isTerminatorChar");
        module.exports = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function text22(state, silent) {
          var pos = state.pos;
    ...
    require_newline = __commonJS2({
      "node_modules/markdown-it/lib/rules_inline/newline.js"(exports, module) {
        "use strict";
        var isSpace = require_utils().isSpace;
        module.exports = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function newline(state, silent) {
    ...
    require_escape = __commonJS2({
      "node_modules/markdown-it/lib/rules_inline/escape.js"(exports, module) {
        ...
        module.exports = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function escape(state, silent) {
    ...
    require_backticks = __commonJS2({
      "node_modules/markdown-it/lib/rules_inline/backticks.js"(exports, module) {
        "use strict";
        module.exports = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function backtick(state, silent) {
    ...
    require_strikethrough = __commonJS2({
      "node_modules/markdown-it/lib/rules_inline/strikethrough.js"(exports, module) {
        "use strict";
        module.exports.tokenize = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function strikethrough(state, silent) {
        ...
        module.exports.postProcess = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function strikethrough(state) {
    ...
    require_emphasis = __commonJS2({
      "node_modules/markdown-it/lib/rules_inline/emphasis.js"(exports, module) {
        "use strict";
        module.exports.tokenize = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function emphasis(state, silent) {
        ...
        __name(postProcess, "postProcess");
        __name2(postProcess, "postProcess");
        module.exports.postProcess = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function emphasis(state) {
          var curr, tokens_meta = state.tokens_meta, max2 = state.tokens_meta.length;
          postProcess(state, state.delimiters);
          for (curr = 0; curr < max2; curr++) {
            if (tokens_meta[curr] && tokens_meta[curr].delimiters) {
    ...
    require_link = __commonJS2({
      "node_modules/markdown-it/lib/rules_inline/link.js"(exports, module) {
        ...
        var normalizeReference = require_utils().normalizeReference;
        var isSpace = require_utils().isSpace;
        module.exports = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function link2(state, silent) {
    ...
    require_image = __commonJS2({
      "node_modules/markdown-it/lib/rules_inline/image.js"(exports, module) {
        ...
        var normalizeReference = require_utils().normalizeReference;
        var isSpace = require_utils().isSpace;
        module.exports = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function image22(state, silent) {
    ...
    require_autolink = __commonJS2({
      "node_modules/markdown-it/lib/rules_inline/autolink.js"(exports, module) {
        ...
        module.exports = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function autolink(state, silent) {
    ...
    require_html_inline = __commonJS2({
      "node_modules/markdown-it/lib/rules_inline/html_inline.js"(exports, module) {
        ...
        module.exports = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function html_inline(state, silent) {
    ...
    require_entity = __commonJS2({
      "node_modules/markdown-it/lib/rules_inline/entity.js"(exports, module) {
        ...
        module.exports = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function entity(state, silent) {
    ...
    require_balance_pairs = __commonJS2({
      "node_modules/markdown-it/lib/rules_inline/balance_pairs.js"(exports, module) {
        ...
        __name2(processDelimiters, "processDelimiters");
        module.exports = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function link_pairs(state) {
          var curr, tokens_meta = state.tokens_meta, max2 = state.tokens_meta.length;
    ...
    require_text_collapse = __commonJS2({
      "node_modules/markdown-it/lib/rules_inline/text_collapse.js"(exports, module) {
        "use strict";
        module.exports = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function text_collapse(state) {
    ...
    require_state_inline = __commonJS2({
      "node_modules/markdown-it/lib/rules_inline/state_inline.js"(exports, module) {
        ...
        __name2(StateInline, "StateInline");
    ...
    require_parser_inline = __commonJS2({
      "node_modules/markdown-it/lib/parser_inline.js"(exports, module) {
        ...
        __name2(ParserInline, "ParserInline");
    ...
    require_linkify_it = __commonJS2({
      "node_modules/linkify-it/index.js"(exports, module) {
        ...
        __name2(isFunction2, "isFunction2");
        function escapeRE(str) {
        ...
        var defaultSchemas = {
          "http:": {
            validate: /* @__PURE__ */ __name2(function(text22, pos, self) {
        ...
        __name2(resetScanCache, "resetScanCache");
        ...
        LinkifyIt.prototype.test = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function test(text22) {
        ...
        LinkifyIt.prototype.pretest = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function pretest(text22) {
          return this.re.pretest.test(text22);
        }, "pretest"), "pretest");
        LinkifyIt.prototype.testSchemaAt = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function testSchemaAt(text22, schema, pos) {
          if (!this.__compiled__[schema.toLowerCase()]) {
            return 0;
          }
          return this.__compiled__[schema.toLowerCase()].validate(text22, pos, this);
        }, "testSchemaAt"), "testSchemaAt");
        LinkifyIt.prototype.match = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function match2(text22) {
          var shift = 0, result = [];
        ...
        LinkifyIt.prototype.tlds = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function tlds(list2, keepOld) {
        ...
        LinkifyIt.prototype.normalize = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function normalize(match2) {
          if (!match2.schema) {
    ...
    require_punycode = __commonJS2({
      "node_modules/punycode/punycode.js"(exports, module) {
        ...
        var ucs2encode = /* @__PURE__ */ __name2((array2) => String.fromCodePoint(...array2), "ucs2encode");
        ...
        var decode = /* @__PURE__ */ __name2(function(input) {
          const output = [];
        ...
        var encode = /* @__PURE__ */ __name2(function(input) {
          const output = [];
    ...
    require_lib = __commonJS2({
      "node_modules/markdown-it/lib/index.js"(exports, module) {
        ...
        __name2(validateLink, "validateLink");
        ...
        __name2(normalizeLink, "normalizeLink");
        ...
        __name2(normalizeLinkText, "normalizeLinkText");
        ...
        __name2(MarkdownIt3, "MarkdownIt3");
    ...
    __export(base_exports, {
      getAstValues: /* @__PURE__ */ __name2(() => getAstValues, "getAstValues"),
      isAst: /* @__PURE__ */ __name2(() => isAst, "isAst"),
      isFunction: /* @__PURE__ */ __name2(() => isFunction, "isFunction"),
      isVariable: /* @__PURE__ */ __name2(() => isVariable, "isVariable"),
      resolve: /* @__PURE__ */ __name2(() => resolve, "resolve")
    });
    __name2(isAst, "isAst");
    __name2(isFunction, "isFunction");
    __name2(isVariable, "isVariable");
    __name2(getAstValues, "getAstValues");
    ...
    __name2(isIdentifier, "isIdentifier");
    __name2(isPromise, "isPromise");
    __name2(findTagEnd, "findTagEnd");
    __name2(parseTag, "parseTag");
    ...
    max = /* @__PURE__ */ __name2((a, b) => Math.max(a, b), "max");
    increment = /* @__PURE__ */ __name2((o, n = 2) => ({
      ...o,
      indent: (o.indent || 0) + n
    }), "increment");
    __name2(formatChildren, "formatChildren");
    __name2(formatInline, "formatInline");
    __name2(formatTableRow, "formatTableRow");
    __name2(formatScalar, "formatScalar");
    __name2(formatAnnotationValue, "formatAnnotationValue");
    __name2(formatAttributes, "formatAttributes");
    __name2(formatAnnotations, "formatAnnotations");
    __name2(formatVariable, "formatVariable");
    __name2(formatFunction, "formatFunction");
    __name2(trimStart, "trimStart");
    __name2(escapeMarkdownCharacters, "escapeMarkdownCharacters");
    __name2(formatNode, "formatNode");
    __name2(formatValue, "formatValue");
    __name2(format, "format");
    __name2(truthy, "truthy");
    __name2(renderConditions, "renderConditions");
    tagIf = {
      attributes: {
    ...
    __name2(convertToRow, "convertToRow");
    ...
    __name2(annotate, "annotate");
    __name2(handleAttrs, "handleAttrs");
    __name2(handleToken, "handleToken");
    __name2(parser, "parser");
    schema_exports = {};
    __export(schema_exports, {
      blockquote: /* @__PURE__ */ __name2(() => blockquote, "blockquote"),
      code: /* @__PURE__ */ __name2(() => code, "code"),
      comment: /* @__PURE__ */ __name2(() => comment, "comment"),
      document: /* @__PURE__ */ __name2(() => document, "document"),
      em: /* @__PURE__ */ __name2(() => em, "em"),
      error: /* @__PURE__ */ __name2(() => error, "error"),
      fence: /* @__PURE__ */ __name2(() => fence, "fence"),
      hardbreak: /* @__PURE__ */ __name2(() => hardbreak, "hardbreak"),
      heading: /* @__PURE__ */ __name2(() => heading, "heading"),
      hr: /* @__PURE__ */ __name2(() => hr, "hr"),
      image: /* @__PURE__ */ __name2(() => image, "image"),
      inline: /* @__PURE__ */ __name2(() => inline, "inline"),
      item: /* @__PURE__ */ __name2(() => item, "item"),
      link: /* @__PURE__ */ __name2(() => link, "link"),
      list: /* @__PURE__ */ __name2(() => list, "list"),
      node: /* @__PURE__ */ __name2(() => node, "node"),
      paragraph: /* @__PURE__ */ __name2(() => paragraph, "paragraph"),
      s: /* @__PURE__ */ __name2(() => s, "s"),
      softbreak: /* @__PURE__ */ __name2(() => softbreak, "softbreak"),
      strong: /* @__PURE__ */ __name2(() => strong, "strong"),
      table: /* @__PURE__ */ __name2(() => table, "table"),
      tbody: /* @__PURE__ */ __name2(() => tbody, "tbody"),
      td: /* @__PURE__ */ __name2(() => td, "td"),
      text: /* @__PURE__ */ __name2(() => text, "text"),
      th: /* @__PURE__ */ __name2(() => th, "th"),
      thead: /* @__PURE__ */ __name2(() => thead, "thead"),
      tr: /* @__PURE__ */ __name2(() => tr, "tr")
    });
    document = {
      render: "article",
      children: [
    ...
    __name2(tagName2, "tagName2");
    __name2(renderArray, "renderArray");
    __name2(deepRender, "deepRender");
    __name2(render2, "render2");
    __name2(reactStatic, "reactStatic");
    ...
    partial = {
      ...
      transform(node2, config2) {
        ...
        const transformChildren = /* @__PURE__ */ __name2((part) => part.resolve(scopedConfig).transformChildren(scopedConfig), "transformChildren");
    ...
    __name2(block, "block");
    __name2(inline2, "inline2");
    __name2(core, "core");
    __name2(plugin, "plugin");
    fence2 = "---";
    __name2(getLine, "getLine");
    __name2(findClose, "findClose");
    __name2(block2, "block2");
    __name2(plugin2, "plugin2");
    OPEN2 = "<!--";
    CLOSE2 = "-->";
    __name2(block3, "block3");
    __name2(inline3, "inline3");
    __name2(plugin3, "plugin3");
    Tokenizer = class {
      static {
    ...
    __name2(typeToString, "typeToString");
    __name2(validateFunction, "validateFunction");
    __name2(displayMatches, "displayMatches");
    __name2(validator, "validator");
    __name2(walkWithParents, "walkWithParents");
    __name2(validateTree, "validateTree");
    tokenizer = new Tokenizer();
    __name2(mergeConfig, "mergeConfig");
    __name2(parse3, "parse3");
    __name2(resolve2, "resolve2");
    __name2(transform2, "transform2");
    __name2(validate2, "validate");
    __name2(createElement, "createElement");
    Markdoc = class {
      static {
        __name(this, "Markdoc");
      }
      static {
        __name2(this, "Markdoc");
      }
      constructor(config2) {
        this.parse = parse3;
...
var require_number_1c017a79_cjs_dev = __commonJS({
  "../node_modules/emery/dist/number-1c017a79.cjs.dev.js"(exports) {
    ...
    __name2(checkAllWith, "checkAllWith");
    ...
    var isEven = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function isEven2(value) {
      return value % 2 === 0;
    }, "isEven2"), "isEven");
    var isOdd = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function isOdd2(value) {
      return Math.abs(value % 2) === 1;
    }, "isOdd2"), "isOdd");
    var isNegativeZero = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function isNegativeZero2(value) {
      return 1 / value === Number.NEGATIVE_INFINITY;
    }, "isNegativeZero2"), "isNegativeZero");
    var isNegative = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function isNegative2(value) {
      return value < 0;
    }, "isNegative2"), "isNegative");
    var isPositive = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function isPositive2(value) {
      return value > 0;
    }, "isPositive2"), "isPositive");
    var isNonNegative = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function isNonNegative2(value) {
      return value >= 0;
    }, "isNonNegative2"), "isNonNegative");
    var isNonPositive = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function isNonPositive2(value) {
      return value <= 0;
    }, "isNonPositive2"), "isNonPositive");
...
var require_emery_guards_cjs_dev = __commonJS({
  "../node_modules/emery/guards/dist/emery-guards.cjs.dev.js"(exports) {
    ...
    __name2(isFulfilled, "isFulfilled");
    function isRejected(result) {
      return result.status === "rejected";
    }
    __name(isRejected, "isRejected");
    __name2(isRejected, "isRejected");
...
var require_emery_opaques_cjs_dev = __commonJS({
  "../node_modules/emery/opaques/dist/emery-opaques.cjs.dev.js"(exports) {
    ...
    __name2(castToOpaque, "castToOpaque");
...
var PathReferenceInput;
var MultiselectFieldInput;
var MultiRelationshipInput;
var IntegerFieldInput;
var NumberFieldInput;
var ImageFieldInput;
var FileFieldInput;
var DatetimeFieldInput;
var DateFieldInput;
var CloudImageFieldInput;
var BlocksFieldInput;
var DocumentFieldInput;
var CheckboxFieldInput;
var createEditorSchema;
var getDefaultValue;
var parseToEditorState;
var serializeFromEditorState;
var parseToEditorStateMDX;
var serializeFromEditorStateMDX;
var createEditorStateFromYJS;
var prosemirrorToYXmlFragment;
var normalizeDocumentFieldChildren;
var slugify;
var serializeMarkdoc;
var emptySet;
var init_index_08620d62_worker = __esm({
  "../node_modules/@keystatic/core/dist/index-08620d62.worker.js"() {
    ...
    __name2(assertRequired, "assertRequired");
    __name2(basicFormFieldWithSimpleReaderParse, "basicFormFieldWithSimpleReaderParse");
    __name2(empty, "empty");
    ...
    __name2(validateText, "validateText");
    __name2(parseAsNormalField, "parseAsNormalField");
...
function deserializeProps(schema, value, files, otherFiles, mode, slug2) {
  return transformProps(schema, value, {
    form: /* @__PURE__ */ __name2((schema2, value2) => {
...
function markdoc({
  ...
  let getSchema = /* @__PURE__ */ __name2(() => {
    if (!schema) {
...
__name(mdx, "mdx");
var import_assertions;
var import_emery;
var import_jsx_runtime2;
var currentlyActiveMarks;
var currentlyDisabledMarks;
var currentLink;
var VariableChildFields;
var emptyCacheNode;
var collectionPath;
var getFormatInfo;
var ContentFieldLocationError;
var textEncoder$1;
var textDecoder$1;
var defaultAltField$1;
var emptyTitleField$1;
var defaultAltField;
var emptyTitleField;
var textDecoder;
var textEncoder;
var init_index_382895ba_worker = __esm({
  "../node_modules/@keystatic/core/dist/index-382895ba.worker.js"() {
    ...
    __name2(getValueAtPropPath, "getValueAtPropPath");
    __name2(transformProps, "transformProps");
    currentlyActiveMarks = /* @__PURE__ */ new Set();
    currentlyDisabledMarks = /* @__PURE__ */ new Set();
    currentLink = null;
    __name2(addMarkToChildren, "addMarkToChildren");
    __name2(setLinkForChildren, "setLinkForChildren");
    __name2(getInlineNodes, "getInlineNodes");
    VariableChildFields = class extends Error {
      static {
        __name(this, "VariableChildFields");
      }
      static {
        __name2(this, "VariableChildFields");
      }
      constructor() {
        super("There are a variable number of child fields");
      }
    };
    __name2(findSingleChildField, "findSingleChildField");
    __name2(_findConstantChildFields, "_findConstantChildFields");
    __name2(couldContainChildField, "couldContainChildField");
    __name2(inlineNodeFromMarkdoc, "inlineNodeFromMarkdoc");
    __name2(inlineChildrenFromMarkdoc, "inlineChildrenFromMarkdoc");
    __name2(inlineFromMarkdoc, "inlineFromMarkdoc");
    __name2(fromMarkdoc, "fromMarkdoc");
    __name2(fromMarkdocNode, "fromMarkdocNode");
    __name2(toChildrenAndProps, "toChildrenAndProps");
    emptyCacheNode = Symbol("emptyCacheNode");
    __name2(memoize, "memoize");
    __name2(fixPath, "fixPath");
    collectionPath = /\/\*\*?(?:$|\/)/;
    __name2(getConfiguredCollectionPath, "getConfiguredCollectionPath");
    getFormatInfo = memoize(_getFormatInfo);
    __name2(_getFormatInfo, "_getFormatInfo");
    ContentFieldLocationError = class extends Error {
      static {
        __name(this, "ContentFieldLocationError");
      }
      static {
        __name2(this, "ContentFieldLocationError");
      }
      constructor(message) {
        super(message);
      }
    };
    __name2(getContentExtension, "getContentExtension");
    __name2(getSrcPrefix, "getSrcPrefix");
    __name2(deserializeFiles, "deserializeFiles");
    __name2(deserializeProps, "deserializeProps");
    __name2(getSrcPrefixForImageBlock, "getSrcPrefixForImageBlock");
    textEncoder$1 = new TextEncoder();
    textEncoder$1.encode("tree ");
    __name2(collectDirectoriesUsedInSchemaInner, "collectDirectoriesUsedInSchemaInner");
    __name2(collectDirectoriesUsedInSchema, "collectDirectoriesUsedInSchema");
    ...
    __name2(normaliseDocumentFeatures, "normaliseDocumentFeatures");
    ...
    __name2(editorOptionsToConfig, "editorOptionsToConfig");
    __name2(getTypeForField, "getTypeForField");
    __name2(fieldsToMarkdocAttributes, "fieldsToMarkdocAttributes");
    __name2(createMarkdocConfig, "createMarkdocConfig");
    textDecoder = new TextDecoder();
    textEncoder = new TextEncoder();
    __name2(getDirectoriesForEditorField, "getDirectoriesForEditorField");
    __name2(markdoc, "markdoc");
    markdoc.createMarkdocConfig = createMarkdocConfig;
    markdoc.inline = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function inlineMarkdoc({
      label,
      description,
      options = {},
      components = {}
    ...
    }, "inlineMarkdoc"), "inlineMarkdoc");
    __name2(mdx, "mdx");
    mdx.inline = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function mdx2({
      label,
      description,
      options = {},
      components = {}
...
var require_dist2 = __commonJS({
  "../node_modules/@braintree/sanitize-url/dist/index.js"(exports) {
    ...
    __name2(isRelativeUrlWithoutProtocol, "isRelativeUrlWithoutProtocol");
    ...
    __name2(decodeHtmlCharacters, "decodeHtmlCharacters");
    ...
    __name(sanitizeUrl2, "sanitizeUrl2");
    __name2(sanitizeUrl2, "sanitizeUrl");
    exports.sanitizeUrl = sanitizeUrl2;
  }
});
var import_jsx_runtime3;
var import_emery2;
var import_sanitize_url;
...
function slug(_args) {
  ...
  __name2(defaultValue, "defaultValue");
...
var import_emery3;
var import_sanitize_url2;
var import_assertions2;
var index;
var init_keystatic_core_worker = __esm({
  "../node_modules/@keystatic/core/dist/keystatic-core.worker.js"() {
    ...
    __name2(collection, "collection");
    __name2(array, "array");
    __name2(select, "select");
    __name2(conditional, "conditional");
    __name2(blocks, "blocks");
    __name2(checkbox, "checkbox");
    __name2(child, "child");
    __name2(cloudImage, "cloudImage");
    __name2(validateDate, "validateDate");
    __name2(date, "date");
    __name2(validateDatetime, "validateDatetime");
    __name2(datetime, "datetime");
    __name2(empty2, "empty");
    __name2(emptyDocument, "emptyDocument");
    __name2(emptyContent, "emptyContent");
    __name2(file, "file");
    __name2(image2, "image");
    __name2(pluralize, "pluralize");
    __name2(validateMultiRelationshipLength, "validateMultiRelationshipLength");
    __name2(multiRelationship, "multiRelationship");
    __name2(multiselect, "multiselect");
    __name2(validateNumber, "validateNumber");
    __name2(decimalPlaces, "decimalPlaces");
    __name2(isAtStep, "isAtStep");
    __name2(number2, "number");
    __name2(pathReference, "pathReference");
    __name2(relationship, "relationship");
    __name2(parseSlugFieldAsNormalField, "parseSlugFieldAsNormalField");
    __name2(parseAsSlugField, "parseAsSlugField");
    __name2(slug, "slug");
    __name2(isValidURL, "isValidURL");
    __name2(validateUrl, "validateUrl");
    __name2(url, "url");
    __name2(ignored, "ignored");
        ...
        stories: collection({
          ...
          schema: {
            ...
            tags: index.array(
              ...
              { label: "Tags", itemLabel: /* @__PURE__ */ __name2((props) => props.value ?? "Tag", "itemLabel") }
            ),
            ...
            tracks: index.array(
              index.object({
                title: index.text({ label: "Track title" }),
                url: index.text({ label: "Audio URL (R2 direct link)" }),
                duration: index.text({
                  label: "Duration",
              ...
              { label: "Audio tracks", itemLabel: /* @__PURE__ */ __name2((props) => props.fields.title.value || "Track", "itemLabel") }
            ),
            body: index.document({
              label: "Content",
              formatting: {
...
__name(isAllowedOrigin2, "isAllowedOrigin2");
...
var init_inquire = __esm({
  "api/inquire.js"() {
    ...
    __name2(isAllowedOrigin2, "isAllowedOrigin");
...
__name(isAllowedOrigin3, "isAllowedOrigin3");
...
var init_subscribe = __esm({
  "api/subscribe.js"() {
    ...
    __name2(isAllowedOrigin3, "isAllowedOrigin");
...
var routes;
var init_functionsRoutes_0_3594718512998618 = __esm({
  "../.wrangler/tmp/pages-W0yNfn/functionsRoutes-0.3594718512998618.mjs"() {
    init_login();
    init_logout();
    init_verify();
    init_number();
...
// .wrangler/tmp/bundle-DEU7Gn/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-DEU7Gn/middleware-loader.entry.ts
...
react/cjs/react-jsx-runtime.development.js:
   ...
   *)
*/
//# sourceMappingURL=functionsWorker-0.36676830098815394.js.map
