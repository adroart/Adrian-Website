...
- [ ] **Finish the collector journey.** _(band: agent-runnable)_ A person buys art, registers it when ready, and it becomes a light on the map. Phases 0 through 2 and private verified sales and reconnection are complete locally. Phase 3.1 contributor access, API, UI, recovery, privacy, authority, replay, and integrated acceptance are complete locally. Attributed contributor material remains blocked on Adrian's content-shape decision. Optional video, warning delivery, and automatic purchase-to-registration also remain. The journey stays launch-disabled. → Spec: [the-collector-journey.md](todo/plans/the-collector-journey.md) · Build: [the-collector-build.md](todo/plans/the-collector-build.md)
