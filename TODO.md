...
- [ ] **Pick the wording for three collector screens (a one-letter choice per screen).** _(band: you-required)_ _(effort: quick)_ — the private collector flow has three screens whose text was never locked: the one about a piece changing hands after a death, the one asking who else lives with the piece, and the arrivals screen. Two drafts exist per screen, written in your voice; reply with a letter per screen and an agent wires them in. Same doc holds two small layout calls with a stated lean. → [collector wording proposals](docs/research/2026-08-12-collector-wording-proposals.md) · research answers on garden timing + video cost: [open questions](docs/research/2026-08-12-collector-open-questions.md)
