...
- [ ] **Walk the collector click-through and settle the open wording.** _(band: you-required)_ The collector journey is wired to the live registry end to end and the registration ceremony, Piece Records, continuity archive, and Successor's Handbook are built, all dark behind `livingLegacy`. Done when every box in the checklist is walked, the eight wording items are settled, and you say the flag can flip. → Gate: [collector-click-through-checklist.md](docs/collector-click-through-checklist.md) · Walkthrough: [collector-walkthrough-guide.md](docs/collector-walkthrough-guide.md) · Master: [collector-screen-wording.md](todo/plans/collector-screen-wording.md)
