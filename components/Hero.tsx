    ...
    <section className="relative w-full h-[105vh] flex flex-col bg-wood-900 overflow-hidden group">
      ...
      >
          <div className="animate-fade-in max-w-4xl">
              <span className="font-mono text-xs text-bronze-400 uppercase tracking-[0.2em] mb-4 block opacity-80">
                  Resonant Artifacts
              </span>
              ...
              <div className="mt-8 md:hidden">
                  <Link
                      to="/creations"
                      className="inline-block font-mono text-xs uppercase tracking-[0.2em] text-paper-50 border border-paper-50/40 hover:border-bronze-400 hover:text-bronze-300 px-6 py-3 transition-colors duration-300"
                  >
                      Explore the Work
                  </Link>
              </div>
      ...
      >
          <span className="font-mono text-[10px] uppercase tracking-[0.2em] text-paper-100/60 ml-[0.5em]">Enter</span>
