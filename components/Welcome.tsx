    ...
    <section className="min-h-screen bg-stone-950 flex flex-col items-center justify-center px-6 py-16">
      <div className="max-w-sm w-full text-center">
        ...
        <div className="flex flex-col gap-3 mb-16">
          <Link
            to="/creations"
            className="w-full py-4 border border-stone-700 text-paper-50 font-mono text-xs uppercase tracking-[0.2em] font-bold hover:bg-paper-50 hover:text-stone-950 transition-colors"
          >
            Creations
          </Link>
          <Link
          ...
          <a
            ...
            className="w-full py-4 border border-stone-700 text-paper-50 font-mono text-xs uppercase tracking-[0.2em] font-bold hover:bg-paper-50 hover:text-stone-950 transition-colors flex items-center justify-center gap-2"
          >
